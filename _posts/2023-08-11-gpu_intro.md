...
and the Intel blogs<sup><a id="link1">2</a></sup> on vectorization.
...
processor has a 24-core, which could run 0.33 TFLOPS
for FP64 and 0.66 TFLOPS for FP32<sup><a id="link1">1</a></sup>.
...
The most recent NVIDIA arch can run 9.7 TFLOPS for FP64, 156 TFLOPS for FP32,
and 312 TFLOPS for FP16 datatypes<sup><a id="link1">1</a></sup>, which are incredible results compared
...
[Intel's blog on Intrinsics](https://www.intel.com/content/www/us/en/docs/intrinsics-guide/index.html)<sup><a id="link1">2</a></sup>.
...
[1.](#link1) Wen-mei W. Hwu, David B. Kirk, Izzat El Hajj, Programming Massively Parallel Processors: A Hands-on Approach, 4th edition, United States: Katey Birtcher; 2022

[2.](#link2) [Intel Intrinsics Guide](https://www.intel.com/content/www/us/en/docs/intrinsics-guide/index.html)

[3.](#link3) Mark Harris, [Implement Performance Metrics](https://developer.nvidia.com/blog/how-implement-performance-metrics-cuda-cc/), NVIDIA Technical Blog, Nove 07, 2012

[4,](#link4) NVIDIA Developer Blog on [Nsight Systems](https://developer.nvidia.com/nsight-systems)
