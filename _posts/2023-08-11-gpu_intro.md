...
<table align="center" style="margin: 0px auto;">
  <tr>
    <th style="text-align: center">n<sub>no. of inputs</sub></th>
    <th style="text-align: center">time<sub>CPU</sub> (ms)</th>
    <th style="text-align: center">time<sub>GPU</sub> (ms)</th>
  </tr>
  <tr>
