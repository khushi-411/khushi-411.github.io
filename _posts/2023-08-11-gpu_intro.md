...
A Hands-on Approach<sup><a id="link1">1</a></sup>" by [Wen-mei W. Hwu](https://scholar.google.com/citations?user=ohjQPx8AAAAJ&hl=en),
...
and the Intel blogs<sup><a id="link2">2</a></sup> on vectorization.
...
FP64i<sup><a id="link1">1</a></sup> and 0.66 TFLOPS for FP32<sup><a id="link1">1</a></sup>.
...
The most recent NVIDIA arch can run 9.7 TFLOPS for FP64<sup><a id="link1">1</a></sup>,
156 TFLOPS for FP32<sup><a id="link1">1</a></sup>,
and 312 TFLOPS for FP16<sup><a id="link1">1</a></sup> datatypes, which are incredible
...
Intel's blog on Intrinsics<sup><a id="link1">2</a></sup>.
...
Let's benchmark our code and verify our results with the theoretical
...
I used Google Benchmark<sup><a id="link5">5</a></sup> to benchmark the CPU's
`vecAdd` function above and CUDA Events<sup><a id="link4">4</a></sup>
...
|  n  | CPU  | GPU |
| ------------- | ------------- | ------------- |
| 100  | 0.000131  | 0.10176  |
| 512  | 0.000662  | 0.099936  |
| 1024  | 0.001462  | 0.102496  |
| 10000  | 0.013018  | 0.096832  |
| 50000  | 0.066477  | 0.074336  |
| 100000  | 0.13253  | 0.051936  |
| 500000  | 0.668984  | 0.072352  |
| 1000000  | 1.455497  | 0.113184  |
| 2000000  | 2.846591  | 0.1992  |

Check out the graphical representation of the same:
...
providing feedback on the initial draft of the blog post.

### Resources & References
[1](#link1). Wen-mei W. Hwu, David B. Kirk, Izzat El Hajj, [Programming Massively Parallel Processors: A Hands-on Approach](https://www.amazon.in/Programming-Massively-Parallel-Processors-Hands/dp/0323912311), 4th edition, United States: Katey Birtcher; 2022
[2](#link2). Intel developers, [Intel Intrinsics Guide](https://www.intel.com/content/www/us/en/docs/intrinsics-guide/index.html), Updated on May 10, 2023
[3](#link3). Mark Harris, [Implement Performance Metrics](https://developer.nvidia.com/blog/how-implement-performance-metrics-cuda-cc/), NVIDIA Technical Blog, November 07, 2012
[4](#link4). NVIDIA's Developer Blog on [Nsight Systems](https://developer.nvidia.com/nsight-systems)
[5](#link5). Google's microbenchmark support library, [benchmark](https://github.com/google/benchmark)
