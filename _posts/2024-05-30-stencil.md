...
into discrete values to process via computers.
Structured grids are used for the finite difference method.
To derive the approximate value of the function for the x,
...
It assumes that each thread block is responsible for
