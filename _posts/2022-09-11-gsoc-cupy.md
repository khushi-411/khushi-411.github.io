...
> *Note*: This post will be originally published on CuPy's official
blog ([https://medium.com/cupy-team](https://medium.com/cupy-team))
after the final results are declared.
The link will be added here soon.
...
I worked on Project 1: [CuPy coverage of NumPy/SciPy functions](https://github.com/cupy/cupy/wiki/GSoC-2022-Project-Ideas#project-1-cupy-coverage-of-numpyscipy-functions)
...
enhanced the coverage of the `special` and `stats` modules in
CuPy. Gladly, I was also able to accomplish extra work (marked
with "*") during the GSoC timeline. I have also worked on
experimental kernel fusion methods, Custom Kernels in CuPy
(mainly Reduction Kernel), and universal kernels. I documented
my code well and added all the possible test cases. I benchmarked
all the functions and used NVIDIA Nsight System for interpolating
functions. Below are the link and a short description of my work.

## Post-GSoC Time

I enhanced CuPy's coverage of NumPy functions. My contributions:
...
I enhanced the coverage of special functions in CuPy.
- APIs covered:
...
I enhanced the coverage of statistical functions in CuPy.
...
source community. I’m glad about how the approach to solve
...
on various issues and also helped newbie contributors review their PR.
